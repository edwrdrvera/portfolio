export const projects = [
  ...
  },
  {
    ...
    link: "https://github.com/alcoranpaul/devhacks2026"
  },
  {
    title: "Tastebuds",
  ...
  {
    title: "PokeLog API",
    description: "A comprehensive API for managing Pokémon data.",
    features: [
      "RESTful API for Pokémon data management",
      "User authentication and authorization",
      "Pokémon data management"
    ],
    tech: ["Node.js", "Express", "Firestore", "Vercel" ],
    link: "https://github.com/edwrdrvera/pokelog-api"
  }
];
